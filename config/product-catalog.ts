...
export const PRODUCT_CATALOG: CatalogEntry[] = [
  ...
  },
  {
    ...
    tagline: {
      en: 'Business document camera with OCR',
      ja: 'OCR搭載ビジネスドキュメントカメラ',
      zh: '搭载OCR的商务文档相机',
    },
    description: {
      en: 'Capture business documents with automatic OCR text extraction for seamless integration with Insight products.',
      ja: 'ビジネス文書を撮影し、自動OCRでテキスト抽出。Insight製品とのシームレスな連携が可能です。',
      zh: '拍摄商务文档，自动OCR文字提取，与Insight产品无缝集成。',
    },
    features: {
      en: ['Document capture', 'OCR text extraction', 'Insight product integration'],
      ja: ['ドキュメント撮影', 'OCRテキスト抽出', 'Insight製品連携'],
      zh: ['文档拍摄', 'OCR文字提取', 'Insight产品集成'],
    },
    useCases: {
      en: ['Digitize paper documents for Insight workflows'],
      ja: ['Insightワークフロー向け紙文書のデジタル化'],
      zh: ['将纸质文档数字化用于Insight工作流'],
    },
    releases: {},
  },
  {
