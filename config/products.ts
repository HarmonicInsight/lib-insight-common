...
export const PRODUCT_FEATURES: Record<ProductCode, FeatureDefinition[]> = {
  ...
  INSS: [
    ...
    },
    {
      ...
      limitValues: { FREE: 20, TRIAL: -1, PRO: 100, ENT: -1 },
    ...
    },
    {
      ...
      allowedPlans: ['FREE', 'TRIAL', 'PRO', 'ENT'],
      limitValues: { FREE: 20, TRIAL: -1, PRO: 100, ENT: -1 },
      descriptionJa: 'AIによるPythonコードの生成・編集でPowerPointを自動処理（AI共通クレジット）',
    },
    {
  ...
  IOSH: [
    ...
    },
    {
      ...
      allowedPlans: ['FREE', 'TRIAL', 'PRO', 'ENT'],
      limitValues: { FREE: 20, TRIAL: -1, PRO: 100, ENT: -1 },
      descriptionJa: 'AIによるPythonコードの生成・編集でExcelを自動処理（AI共通クレジット）',
    },
    {
      key: 'reference_materials',
      name: 'Reference Materials',
  ...
  IOSD: [
    ...
    },
    {
      ...
      allowedPlans: ['FREE', 'TRIAL', 'PRO', 'ENT'],
      limitValues: { FREE: 20, TRIAL: -1, PRO: 100, ENT: -1 },
      descriptionJa: 'AIによるPythonコードの生成・編集でWordを自動処理（AI共通クレジット）',
    },
    {
      key: 'reference_materials',
      name: 'Reference Materials',
  ...
  INPY: [
    ...
    },
    {
      ...
      allowedPlans: ['FREE', 'TRIAL', 'PRO', 'ENT'],
      limitValues: { FREE: 20, TRIAL: -1, PRO: 100, ENT: -1 },
      descriptionJa: 'AIによるPythonコードの生成・編集・構文検証・デバッグ支援（AI共通クレジット）',
    },
  ],
