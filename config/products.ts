...
export interface ProjectFileConfig {
   ...
   * - ai_memory_deep/（ディープストレージ: BIZ/ENT のみ）
   *
...
export const PRODUCT_FEATURES: Record<ProductCode, FeatureDefinition[]> = {
  ...
  IOSH: [
    ...
    },
    {
      ...
      allowedPlans: ['TRIAL', 'BIZ', 'ENT'],
      limitValues: { TRIAL: -1, BIZ: -1, ENT: -1 },
      descriptionJa: 'AI が既存 Excel データをデータ収集テンプレートに自動転記（BYOK — 回数制限なし・クライアント自社APIキー使用）',
    },
    {
  ...
  INBT: [
    ...
    },
    {
      ...
      descriptionJa: '管理可能な Agent（InsightOffice 端末）数（BIZ: 50台 / ENT: 無制限）',
    },
    {
      key: 'scheduler',
      name: 'Job Scheduler',
  ...
  // ========================================
  INCA: [
    { key: 'rpa_analysis', name: 'RPA Analysis', nameJa: 'RPA解析', type: 'boolean', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], descriptionJa: 'BizRobo等のRPAソース解析' },
    { key: 'lowcode_analysis', name: 'Low-code Analysis', nameJa: 'ローコード解析', type: 'boolean', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], descriptionJa: 'Forguncy等のローコードツール解析' },
    { key: 'migration_assessment', name: 'Migration Assessment', nameJa: '移行アセスメント', type: 'boolean', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], descriptionJa: '工数見積もり・複雑度分析' },
    ...
    { key: 'export_json', name: 'JSON Export', nameJa: 'JSON出力', type: 'boolean', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], descriptionJa: '解析結果のJSON形式出力' },
    { key: 'export_markdown', name: 'Markdown Export', nameJa: 'Markdown出力', type: 'boolean', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], descriptionJa: '解析結果のMarkdown形式出力' },
  ],
  ...
  // ========================================
  INIG: [
    { key: 'generate_image', name: 'Image Generation', nameJa: '画像生成', type: 'boolean', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], descriptionJa: 'Stable Diffusionによる画像生成' },
    { key: 'batch_image', name: 'Batch Image Generation', nameJa: 'バッチ画像生成', type: 'boolean', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], descriptionJa: '複数画像の一括生成' },
    { key: 'generate_audio', name: 'Audio Generation', nameJa: '音声生成', type: 'boolean', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], descriptionJa: 'VOICEVOXによる音声生成' },
    { key: 'character_prompts', name: 'Character Prompts', nameJa: 'キャラクタープロンプト', type: 'limit', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], limitValues: { TRIAL: -1, BIZ: -1, ENT: -1 }, descriptionJa: '保存可能なキャラクタープロンプト数' },
  ...
  // ========================================
  INMV: [
    { key: 'generate', name: 'Video Generation', nameJa: '動画生成', type: 'boolean', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], descriptionJa: '画像・テキストから動画を生成' },
  ...
  // ========================================
  ISOF: [
    { key: 'create_new', name: 'Create New Document', nameJa: '新規作成', type: 'boolean', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], descriptionJa: '空の Excel スプレッドシート・Word ドキュメントを新規作成（MS Office 不要）' },
    { key: 'spreadsheet', name: 'Spreadsheet', nameJa: '表計算', type: 'boolean', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], descriptionJa: 'Excelファイルの読み込み・編集・保存' },
    { key: 'document', name: 'Document', nameJa: '文書作成', type: 'boolean', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], descriptionJa: 'Wordドキュメントの読み込み・編集・保存' },
    { key: 'icloud_mail', name: 'iCloud Mail', nameJa: 'iCloudメール', type: 'boolean', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], descriptionJa: 'iCloudメールの送受信（iPhoneと同じメールをPCで閲覧）' },
    ...
    { key: 'voice_input', name: 'Voice Input', nameJa: '音声入力', type: 'boolean', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], descriptionJa: '音声認識によるハンズフリー入力' },
    { key: 'text_to_speech', name: 'Text to Speech', nameJa: '読み上げ', type: 'boolean', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], descriptionJa: 'メール・文書の音声読み上げ' },
    { key: 'font_scaling', name: 'Font Scaling', nameJa: '文字サイズ調整', type: 'boolean', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], descriptionJa: '文字サイズ50%〜200%の拡大縮小' },
    { key: 'setup_wizard', name: 'Setup Wizard', nameJa: '初期設定ウィザード', type: 'boolean', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], descriptionJa: '5ステップの簡単初期設定（名前・メール・文字サイズ）' },
    { key: 'tutorial', name: 'Tutorial', nameJa: 'チュートリアル', type: 'boolean', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], descriptionJa: '10ステップの対話型ガイドツアー' },
    { key: 'print', name: 'Print', nameJa: '印刷', type: 'boolean', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], descriptionJa: 'シニア向け大きい文字での印刷' },
    { key: 'contacts', name: 'Contacts', nameJa: '連絡先管理', type: 'boolean', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], descriptionJa: '家族・友人・病院等のグループ別連絡先管理' },
  ],
  ...
  // ========================================
  IVIN: [
    { key: 'interview_session', name: 'Interview Session', nameJa: 'インタビューセッション', type: 'boolean', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], descriptionJa: 'AIインタビューセッションの作成・実行' },
    { key: 'voice_input', name: 'Voice Input', nameJa: '音声入力', type: 'boolean', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], descriptionJa: '音声認識によるインタビュー回答の入力' },
    { key: 'voice_synthesis', name: 'Voice Synthesis', nameJa: '音声合成', type: 'boolean', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], descriptionJa: 'AI面接官の質問読み上げ（TTS）' },
    { key: 'excel_grid', name: 'Excel Grid View', nameJa: 'Excelグリッド表示', type: 'boolean', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], descriptionJa: 'Syncfusion ej2-react-grids によるインタビュー結果の一覧表示・ソート・フィルタ' },
    { key: 'excel_import', name: 'Excel Import', nameJa: 'Excelインポート', type: 'boolean', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], descriptionJa: 'Excel ファイルからのデータ取り込み（テンプレート・回答者・案件の一括登録）' },
    { key: 'excel_export', name: 'Excel Export', nameJa: 'Excelエクスポート', type: 'boolean', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], descriptionJa: 'インタビュー結果のExcel形式エクスポート' },
    { key: 'ai_analysis', name: 'AI Analysis', nameJa: 'AI分析', type: 'limit', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], limitValues: { TRIAL: -1, BIZ: -1, ENT: -1 }, descriptionJa: 'AIによる回答の構造化・感情分析・課題抽出（BYOK — 回数制限なし・クライアント自社APIキー使用）' },
    { key: 'data_mart', name: 'Data Mart', nameJa: 'データマート', type: 'boolean', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], descriptionJa: 'インタビュー結果の自動分類・ナレッジマート生成' },
    { key: 'search', name: 'Full-text Search', nameJa: '全文検索', type: 'boolean', allowedPlans: ['TRIAL', 'BIZ', 'ENT'], descriptionJa: 'インタビュー回答のハイブリッド検索' },
...
export const DEFAULT_PLAN_LIMITS: Record<PlanCode, PlanLimits> = {
  ...
  BIZ: { monthlyLimit: -1, maxFileSizeMB: -1, maxStorageItems: -1, maxResolution: '4K', hasWatermark: false, batchEnabled: true, apiEnabled: false, priorityProcessing: true },
 ...
 * checkProductFeature('INMV', 'subtitle', 'ENT')  // true
 */
 ...
 * 機能に必要な最低プランを取得
 *
 * TRIAL は評価用の特殊プランのため除外し、購入可能なプラン（BIZ/ENT）から
