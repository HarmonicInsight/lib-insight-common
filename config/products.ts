...
export const PRODUCT_FEATURES: Record<ProductCode, FeatureDefinition[]> = {
  ...
  INSS: [
    ...
    },
    {
      ...
      allowedPlans: ['TRIAL', 'STD', 'PRO', 'ENT'],
      limitValues: { TRIAL: -1, STD: 50, PRO: -1, ENT: -1 },
      descriptionJa: 'AIによるスライドテキストの校正・改善提案（STD: 月50回 / PRO: 無制限）',
    },
    {
      key: 'ai_editor',
      name: 'AI Code Editor',
      ...
      allowedPlans: ['TRIAL', 'STD', 'PRO', 'ENT'],
      limitValues: { TRIAL: -1, STD: 50, PRO: -1, ENT: -1 },
      descriptionJa: 'AIによるPythonコードの生成・編集でPowerPointを自動処理（STD: 月50回 / PRO: 無制限）',
    },
    {
  ...
  IOSH: [
    ...
    },
    {
      ...
      allowedPlans: ['TRIAL', 'STD', 'PRO', 'ENT'],
      limitValues: { TRIAL: -1, STD: 50, PRO: -1, ENT: -1 },
      descriptionJa: 'AIによるPythonコードの生成・編集でExcelを自動処理（STD: 月50回 / PRO: 無制限）',
    },
    {
      key: 'reference_materials',
      name: 'Reference Materials',
  ...
  IOSD: [
    ...
    },
    {
      ...
      allowedPlans: ['TRIAL', 'STD', 'PRO', 'ENT'],
      limitValues: { TRIAL: -1, STD: 50, PRO: -1, ENT: -1 },
      descriptionJa: 'AIによるドキュメントの校正・要約・構成提案（STD: 月50回 / PRO: 無制限）',
    },
    {
      key: 'ai_editor',
      name: 'AI Code Editor',
      ...
      allowedPlans: ['TRIAL', 'STD', 'PRO', 'ENT'],
      limitValues: { TRIAL: -1, STD: 50, PRO: -1, ENT: -1 },
      descriptionJa: 'AIによるPythonコードの生成・編集でWordを自動処理（STD: 月50回 / PRO: 無制限）',
    },
    {
      key: 'reference_materials',
      name: 'Reference Materials',
  ...
  INPY: [
    ...
    },
    {
      ...
      allowedPlans: ['TRIAL', 'STD', 'PRO', 'ENT'],
      limitValues: { TRIAL: -1, STD: 50, PRO: -1, ENT: -1 },
      descriptionJa: 'AIによるPythonコードの生成・編集・構文検証・デバッグ支援（STD: 月50回 / PRO: 無制限）',
    },
  ],
