...
export const PRODUCT_FEATURES: Record<ProductCode, FeatureDefinition[]> = {
  ...
  INSS: [
    ...
    },
    {
      ...
      allowedPlans: ['TRIAL', 'STD', 'PRO', 'ENT'],
      limitValues: { TRIAL: -1, STD: 50, PRO: 200, ENT: -1 },
      descriptionJa: 'AIによるPythonコードの生成・編集でPowerPointを自動処理（STD: 月50回 / PRO: 月200回 / ENT: 無制限）',
    },
    {
  ...
  IOSH: [
    ...
    },
    {
      ...
      allowedPlans: ['TRIAL', 'STD', 'PRO', 'ENT'],
      limitValues: { TRIAL: -1, STD: 50, PRO: 200, ENT: -1 },
      descriptionJa: 'AIによるPythonコードの生成・編集でExcelを自動処理（STD: 月50回 / PRO: 月200回 / ENT: 無制限）',
    },
    {
      key: 'reference_materials',
      name: 'Reference Materials',
  ...
  IOSD: [
    ...
    },
    {
      ...
      allowedPlans: ['TRIAL', 'STD', 'PRO', 'ENT'],
      limitValues: { TRIAL: -1, STD: 50, PRO: 200, ENT: -1 },
      descriptionJa: 'AIによるPythonコードの生成・編集でWordを自動処理（STD: 月50回 / PRO: 月200回 / ENT: 無制限）',
    },
    {
      key: 'reference_materials',
      name: 'Reference Materials',
