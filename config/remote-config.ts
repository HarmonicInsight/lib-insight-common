...
export const INSIGHT_OFFICE_DEFAULT_FEATURE_FLAGS: FeatureFlag[] = [
  ...
  },
  {
    ...
    products: ['INSS', 'IOSH', 'IOSD', 'ISOF', 'INBT', 'INPY'] as ProductCode[],
    strategy: 'plan_based',
    allowedPlans: ['BIZ', 'ENT'] as PlanCode[],
    value: true,
    description: {
      ja: 'サイレント自動更新（バックグラウンドDL → 次回起動時適用）を有効化（BIZ/ENT のみ）',
      en: 'Enable silent auto-update (background download, apply on next launch) for BIZ/ENT',
    },
    updatedAt: '2026-02-23T00:00:00Z',
  },
  {
