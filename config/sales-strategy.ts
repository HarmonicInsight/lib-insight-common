...
const CONSULTING_MARKETS: TargetMarket[] = [
  ...
  },
  {
    ...
    notes: 'Office利用率の高い市場。現地パートナー経由での法人導入。',
  },
];
  ...
  ISOF: {
    ...
    targetMarkets: [
      {
        ...
        currencies: ['JPY'],
        salesMethods: ['direct_consulting', 'partner_reseller'],
        notes: '地方創生・デジタルディバイド解消コンサル案件。自治体DX予算・総務省デジタル活用支援推進事業と連動。企業のシニア社員向け導入。',
      },
      {
        region: 'SEA',
        phase: 3,
    ...
    customerSegments: [
      {
        ...
        nameJa: '自治体DX推進部門',
        description: 'デジタルディバイド解消・住民向けIT講座で使用するツール導入',
        companySize: 'large',
        recommendedPlan: 'ENT',
      },
      {
    ...
    marketingChannels: [
      ...
      },
      {
        ...
        targetRegions: ['JP'],
        priority: 2,
        description: '自治体DX推進・デジタルディバイド解消事業への提案。',
      },
      {
    ...
    positioning: 'Office不要でExcelファイルを扱えるシニア向け統合ツール。AIが操作を手伝い、iPhoneのメールもPCで見られる。デジタルディバイド解消の切り札。',
  },
};
