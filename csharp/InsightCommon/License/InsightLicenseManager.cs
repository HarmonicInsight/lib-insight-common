...
public class InsightLicenseManager
{
    ...
    private static readonly Regex LICENSE_KEY_REGEX = new(
        @"^(INSS|IOSH|IOSD|INPY|INMV|INBT|INCA|INIG|IVIN|ISOF)-(TRIAL|BIZ|ENT)-(\d{4})-([A-Z0-9]{4})-([A-Z0-9]{4})-([A-Z0-9]{4})$",
    ...
    /// <param name="productName">製品名 (Insight Deck Quality Gate, Insight Performance Management, Insight AI Doc Factory, etc.)</param>
