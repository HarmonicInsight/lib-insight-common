# InsightSlide ライセンス統合プロンプト

このプロンプトを InsightSlide リポジトリで実行してライセンス機能を追加します。
...
```
InsightSlide に insight-common のライセンス管理機能を統合してください。
...
### 7. 設定画面にライセンス管理を追加
設定画面のコンポーネントに LicenseActivation を組み込み
