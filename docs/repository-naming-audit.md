...
| 8 | `app-insight-movie-gen-win-C` | `win-app-insight-movie-gen` | C# | InsightMovie (INMV) | |
...
| 2 | `app-insight-bi-web` | `web-app-insight-bi` | TS | デモサイト | |
...
| 7 | `InsightTidy` | `web-app-insight-tidy` | TS | 片付けアドバイス | |
...
| 12 | `app-Insight-keeper-C` | `web-app-insight-keeper` | TS | 業務ボックス仕分け | ※実はTS（-C誤り） |
...
| 7 | `app-manualsnap-android` | `android-app-manualsnap` | Kotlin | ハードスキャン取込 |
...
| 4 | `app-insight-movie-ios` | `ios-app-insight-movie` | Swift | InsightMovie iOS版 |
...
| 5 | `insight-youtube-collector` | `cross-tool-youtube-collector` | tool | YTテキスト収集 | |
...
| `app-insight-movie-gen-win` | `win-app-insight-movie-gen-legacy` | ARCH | Python版 |
...
| **INMV** | InsightMovie | `win-app-insight-movie-gen` | `ios-app-insight-movie` |
