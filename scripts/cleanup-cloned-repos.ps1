...
#   .\cleanup-cloned-repos.ps1 -Delete -Keep "lib-insight-common","wpf-app-insight-slides"
#
#   # 保持リストをファイルで指定
...
if (-not $Delete) {
    ...
    Write-Host "  .\cleanup-cloned-repos.ps1 -Delete -Keep `"lib-insight-common`",`"wpf-app-insight-slides`"" -ForegroundColor DarkGray
    exit 0
}
